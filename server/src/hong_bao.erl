...
%%% External   API
%%% ========== ======================================== ====================
test (Total, Number) when Total > 0 andalso Number > 0 andalso Total * ?YUAN_TO_FEN >= Number->
...
loop_open (TotalFen, Index, Index, {Min, Max}, List) ->
    ...
    io:format("(~2..0w) $ ~6.2.0f +++ $ ~6.2.0f~n", [Index, Money / ?YUAN_TO_FEN, NewTotal / ?YUAN_TO_FEN]),
